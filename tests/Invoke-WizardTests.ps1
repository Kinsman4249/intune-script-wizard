...
# --------------------------------------------------------------- Templates
# Stage 7: -BackupAll's .ps1 template export (lib/Template.ps1). Exercised
# end to end through the real entry point; New-WizardTemplateHeader and
# Format-WizardGroupDirective are pure enough to also unit-test directly -
# see the block near the end of this section.
